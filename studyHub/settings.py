...
SECRET_KEY = 'django-insecure-l#h03mma*q*^ck7uq1of*fewb4d+*ee!5!p$@0cibl^zdvi4rv'
...
MIDDLEWARE = [
    ...
    'studyApp.middleware.LogRequestsMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'studyApp' / 'templates' / 'studyApp'],  # Add this line
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/tmp/debug.log',  # Adjust the path and filename as needed
    ...
    'loggers': {
        ...
        'studyApp': {  # Adjust to your app's name
            'handlers': ['file'],
            'level': 'DEBUG',
            'propagate': True,
        },
